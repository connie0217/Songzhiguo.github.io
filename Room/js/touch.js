...
(function($) {
    var touch = {}, touchTimeout, tapTimeout, swipeTimeout, longTapTimeout, longTapDelay = 1200, gesture;
    ...
    [ "swipe", "swipeLeft", "swipeRight", "swipeUp", "swipeDown", "doubleTap", "singleTap", "longTap" ].forEach(function(eventName) {
